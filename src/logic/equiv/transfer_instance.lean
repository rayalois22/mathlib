...
let zero := e.has_zero, add := e.has_add, one := e.has_one, mul := e.has_mul,
  nsmul := e.has_smul ℕ, npow := e.has_pow ℕ in
...
let zero := e.has_zero, add := e.has_add, one := e.has_one, mul := e.has_mul, neg := e.has_neg,
  sub := e.has_sub, nsmul := e.has_smul ℕ, zsmul := e.has_smul ℤ, npow := e.has_pow ℕ in
...
let zero := e.has_zero, add := e.has_add, one := e.has_one, mul := e.has_mul, neg := e.has_neg,
  ...
  nsmul := e.has_smul ℕ, zsmul := e.has_smul ℤ, npow := e.has_pow ℕ, zpow := e.has_pow ℤ in
